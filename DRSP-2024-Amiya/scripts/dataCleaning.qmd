...
Let's now use our function from earlier to check how many words articles 904 and 893 differ by.

```{r}
compare_articles(data, vocab, 904, 893)
```

The two articles with the 200th highest similarity score differ by 8 words.
